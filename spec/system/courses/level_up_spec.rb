...
feature "Student levelling up", js: true do
  ...
  context "when a teammate hasn't completed all milestone targets" do
    ...
    scenario 'student is blocked from leveling up until teammate submits work on target' do
      ...
      expect(page).to have_text("You have completed all required milestone lessons, but one or more of your team mates have not. Please ask them to sign in and check for incomplete milestone lessons.")
      expect(page).not_to have_button('Start Next Chapter')
